...
def handle_process_documents(data: DocumentLoaderRequest) -> DocumentLoaderResponse:
    ...
    """
    try:
        processor = DocumentLoader(source_dir=data.source_dir, collection_name=data.collection_name)
...
def handle_document_search(data: DocumentSearchRequest) -> str:
    ...
    """
    try:
        document_search = DocumentSearch(collection_name=data.collection_name, user_input=data.user_input)
