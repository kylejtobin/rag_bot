...
- **Immediate Develo# 🤖 rag_bot
### A Modern Stack for Building Retrieval Augmented Generation Chatbots
![RagBot Factory](/img/chatbot_factory_line_pano.png)
...
pment:** You don't need to wait. You can dive right in! Load content into techdocs, test out chatting on that content, and then start pioneering custom tools for your use case!
